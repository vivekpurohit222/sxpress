                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="file:///C:/Users/Meet/Desktop/template%20(2)/template/admin/Form2.html#">Dashboard</a></li>
                            <li><a href="file:///C:/Users/Meet/Desktop/template%20(2)/template/admin/Form2.html#">FreightMemo Table</a></li>
                              ...
                              <div class="card-body">
                                  ...
                                  <form action="" method="post" novalidate="novalidate">
                                        <div class="row">
                                            <div class="col-12 col-lg-4">
                                              ...
                                              <div class="col-12 col-lg-4">
                                                ...
                                                <div class="input-group">
                                                  <input name="" type="date" class="form-control cc-name valid">
                                                  </div>
                                              </div>
                                              <div class="col-12 col-lg-4">
                                       ...
                                       <div class="row">
                                            <div class="col-12 col-lg-6">
                                              <div class="form-group">
                                                  <label for="cc-exp" class="control-label mb-1"><strong>Truck No.</strong></label>
                                      ...
                                      <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th scope="col" style="width: 20%"><strong>To.</strong></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <textarea name="textarea-input" id="textarea-input" rows="8"  class="form-control"></textarea>
                                                </th>
