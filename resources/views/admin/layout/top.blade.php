<meta charset="utf-8">
    ...
    <link href="{{asset('public/admin/css/lib/vector-map/jqvmap.min.css')}}" rel="stylesheet">
...
<!-- 
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>  -->
    <link rel="stylesheet" href="{{asset('public/admin/css/lib/chosen/chosen.min.css')}}">
